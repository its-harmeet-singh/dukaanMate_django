...
const PaymentStatusPage = ({setNumberOfCartItems}) => {
    ...
    useEffect(function () {
      ...
      const payemntId = queryParams.get("PaymentId");
      const payId = queryParams.get("PayerID")
      const ref = queryParams.get("ref")

      if(payemntId && payId && ref) {
        api.post(`paypal_payment_callback/?paymentId=${payemntId}&PayerID=${payId}&ref=${ref}`)
        .then(res => {
