...
from .searlizers import ProductSerializer, DetailedProductSerializer, UserSerializer, CartItemSerializer, SimpleCartSerializer, CartSerializer
...
def initiate_payment(request):
    if request.user:
        try:
            ...
            print("key" + settings.FLUTTERWAVE_SECRET_KEY)
